...
# def scan(i2csocket, daqsocket, startthr, stopthr, nstep, injectedChannels,calib_dac_0,odir,keepRawData=0) :
def scan(i2csocket, daqsocket, startthr, stopthr, nstep, injectedChannels,calib_dac,odir,keepRawData=0) :
        ...
        for toa_val in range(startthr, stopthr, nstep) :
                ...
                i2csocket.sipm_configure_injection(injectedChannels, activate=1, gain=0, calib_dac=calib_dac_val)
